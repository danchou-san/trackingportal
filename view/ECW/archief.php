...
$archief = "SELECT * FROM archief";

$stmt = $db->connect()->query($archief);
?>
...
<html lang="en">
    <head>
        <title>Archief - ECW Tracking Portal</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="archief.php">Transport archief</a></li>
                    </ul>
